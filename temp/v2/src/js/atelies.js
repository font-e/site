...
function renderDetailDOM(artist) {
  ...
  const linksHTML = `
    <div class="detail-links-wrap" id="detail-links-wrap">
      ${artist.links && artist.links.instagram ? `<span class="detail-link-btn">${artist.links.instagram}</span>` : ''}
      ${artist.links && artist.links.portfolio ? `<span class="detail-link-btn">${artist.links.portfolio}</span>` : ''}
    </div>
  `;
      ...
      <div class="detail-content-column">
        ...
        <div class="detail-body-scrollable" id="detail-body-scrollable">
          <div class="detail-body-wrap">
            <h2 class="detail-artist-heading">${artist.nome}</h2>
